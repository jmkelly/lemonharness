...
// v3: Extract heuristics from recent errors (compact)
      ...
      if (currentPhase.phase === "reserve" && previousPhase !== "reserve") {
        ...
        try {
          const summaryMod = await import("./summary");
