...
description: >
  ...
  principles (predictability, information hierarchy, leading words,
  completion criteria, progressive disclosure) that make a skill
  predictable and low-load. Use when creating a new skill, reviewing
  an existing one, or pruning a skill that has grown stale.
source: Matt Pocock (mattpocock/skills)
---
